...
export function AnimatedTestimonials({
  title = "#Kata Mereka",
  subtitle = "Cerita mereka adalah alasan kami terus mengembangkan sistem ini agar belajar selalu jadi perjalanan yang menyenangkan.",
  badgeText = "Trusted by Kemendikbud",
  testimonials = [],
      ...
      <div className="px-4 md:px-6">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col justify-center">
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                <span className="text-red-600 font-extrabold text-9xl leading-none">#</span>
                <div className="flex flex-col leading-none">
                  <span className="text-black font-extrabold text-5xl md:text-6xl ">Kata</span>
                  <span className="text-blue-600 font-extrabold text-5xl md:text-6xl">Mereka</span>
                </div>
              </div>
          ...
          <motion.div variants={itemVariants} className="relative h-full mr-10 min-h-[300px] md:min-h-[400px]">
            ...
            {/* Decorative elements */}
            <div className="absolute -bottom-6 -left-6 h-24 w-24 rounded-xl bg-blue-600"></div>
            <div className="absolute -top-6 -right-6 h-24 w-24 rounded-xl bg-blue-600"></div>
          </motion.div>
        </motion.div>
